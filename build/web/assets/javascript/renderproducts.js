    ...
    <div class="grid__row mt-20">
        <div class="grid__column-4">
            <div class="review-product">
                <div class="review-product__img" style="background-image: ${
                  productRender.image
                }"></div>
                    ...
                    <div class="grid__row">
                        ...
                        <div class="grid__column-3">                                 
                            <div class="review-product__like">
                                ...
                                <span class="quality-like">Đã thích (${
                                  productRender.liked
                                })</span>
                            </div>
                        </div>
        ...
        <div class="grid__column-6">
            <div class="info-product">
                ...
                <div class="product-quatity">
                    ...
                    <div class="product-rest"><span class="qualityJS">${
                      productRender.rest
                    }</span> sản phẩm có sản</div>
                </div>
    ...
    <div class="info-shopct mt-20">
        ...
        <div class="achievements-shop">
            <div class="achievements-shop__ct">
                <div class="achievements-content">Đánh Giá<span style="color: red; margin-left: 6px;">${
                  productRender.evaluate
                }</span></div>
                <div class="achievements-content1">Sản Phẩm<span style="color: red; margin-left: 6px;">${
                  productRender.productShops
                }</span></div>
            </div>
            <div class="achievements-shop__ct">
                <div class="achievements-content">Tỉ Lệ Phản Hồi<span style="color: red; margin-left: 6px;">${
                  productRender.feedback
                }</span></div>
                <div class="achievements-content1">Thời Gian Phản Hồi<span style="color: red; margin-left: 6px;">Trong vài giờ</span></div>
            </div>
            <div class="achievements-shop__ct">
                <div class="achievements-content">Tham Gia<span style="color: red; margin-left: 6px;">${
                  productRender.join
                }</span></div>
                <div class="achievements-content1">Người Theo Dõi<span style="color: red; margin-left: 6px;">${
                  productRender.follow
                }</span></div>
            </div>
        </div>
    </div>
            ...
            <div class="product-description mt-20">
                ...
                <div class="product-description-contain">
                    ...
                    <div class="product-description-key-contain">
                        ...
                        <div class="product-description-value"><a href="#" class="color-title">${
                          productRender.tradeMark
                        }</a></div>
                    </div>
                    <div class="product-description-key-contain">
